import { multipartFormRequestOptions, createForm } from '@midday-ai/engine/core';
import { Blob } from '@midday-ai/engine/_shims/index';
import { toFile } from '@midday-ai/engine';
